...
function init() {
  ...
  if (state.pause.introStartBtn) {
    state.pause.introStartBtn.addEventListener('click', startFromIntro);
  }
  ...
  document.addEventListener('keydown', event => {
    ...
    const pauseToggleDisabled = isGameFinished || isDuringNameEntry || isShowingScoreboard;
