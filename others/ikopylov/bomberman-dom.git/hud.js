...
function update() {
  ...
  if (state.multiplayer && state.spectator) {
    if (state.hud.livesDisplay) state.hud.livesDisplay.textContent = '—';
    if (state.hud.bombsDisplay) state.hud.bombsDisplay.textContent = '—';
    return;
  }
