...
// LocationsIndex corresponds to the JSON returned by
...
func HandleFilters(w http.ResponseWriter, r *http.Request) {
	...
	// 3. Number-of-members (checkboxes). If user picks "5," we interpret that as "5 or more."
