...
func CreateNotification(userID int, notificationType, title, message string, relatedPostID, relatedCommentID, relatedUserID *int) error {
	...
	if relatedPostID != nil {
		notificationData["related_post_id"] = *relatedPostID
	}
	if relatedCommentID != nil {
		notificationData["related_comment_id"] = *relatedCommentID
	}
	if relatedUserID != nil {
		notificationData["related_user_id"] = *relatedUserID
	}
