// Package database: shared schema structs used across handlers and scan helpers.
// Responsibilities: define data models that mirror DB rows and JSON responses.
package database
