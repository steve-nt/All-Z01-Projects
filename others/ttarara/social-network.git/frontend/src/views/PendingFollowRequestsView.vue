...
// Clear the red-dot indicator for private follow requests only.
// (Public follow notifications should still appear in Notifications.)
onMounted(() => {
  notificationsStore.markFollowRequestsAsRead().catch(() => {});
});
</script>
