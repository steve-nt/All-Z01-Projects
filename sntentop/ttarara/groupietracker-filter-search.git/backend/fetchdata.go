...
// Init fetches all artists and their details on startup
// comment out the entire function to trigger 500 error
// Init initializes the artists and fetches additional details concurrently, preserving order.
func Init() {
